    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden" style={{backgroundColor: '#111111'}}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-[800] tracking-tight text-white mb-6 leading-[1.1]">
            為工作而生的<br />
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 leading-relaxed font-normal max-w-3xl mx-auto">
            無論您是自由工作者、遠端團隊，還是需要專注空間的學習者，<br />
