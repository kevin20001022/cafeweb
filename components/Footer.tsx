...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className={`border-t border-gray-200 dark:border-gray-800 py-12 relative z-10 transition-colors duration-300 ${(currentPage === 'pass' || currentPage === 'contribute' || currentPage === 'about') ? 'bg-white dark:bg-[#1a1a1a]' : ''}`} style={currentPage === 'home' ? {backgroundColor: '#1a1a1a'} : undefined}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-6">
          <Link to="/about" className="text-cafeting-gray dark:text-gray-400 hover:text-cafeting-green dark:hover:text-cafeting-green transition-colors text-sm">關於我們</Link>
